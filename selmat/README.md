...
<a href="#rapida">Instalação de Julia + Anaconda + VSCode</a>
...
3. <a href="#vscode-install">Instalação do Vs Code pelo windows powershell</a>

<hr>

4. <a href="#int">Integração da linguagem Julia no jupyter-notebook</a>
5. <a href="#init-vscode">Configurando o VS Code</a>

<hr>

6. <a href="#exemplo">Exemplo de otimização</a>

<hr>

7. <a href="#julia-install2">Instalação do Julia pelo modo gráfico</a>
8. <a href="#anaconda-install2">Instalação do Anaconda pelo modo gráfico</a>



# Instalar Julia + Jupyter Notebook + VS Code

<div id="rapida"></div>

Para versões <i>Windows</i>, utilize o Prompt de comando <i>PowerShell</i> e siga as seguintes instruções:
...
## Instalação no Windows de Julia + Jupyter Notebook + VS Code
...
## Instalação em Linux Ubuntu e derivados
